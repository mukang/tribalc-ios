...
- (UIView *)createAddressAndPhoneViewWithFrame:(CGRect)frame {
    ...
    UIButton *phoneBtn = [TCComponent createImageBtnWithFrame:CGRectMake(view.width - 20 - 15, addressLab.y, 15, 15) AndImageName:@"res_phone" AndAction:@selector(touchPhoneBtn)];
    [view addSubview:phoneBtn];
    UIButton *addressBtn = [TCComponent createImageBtnWithFrame:CGRectMake(phoneBtn.x, phoneLab.y, phoneBtn.width, phoneBtn.height) AndImageName:@"res_location2" AndAction:@selector(touchLocationBtn)];
