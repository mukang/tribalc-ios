...
- (void)prepareNav {
    ...
    navItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"nav_back_item_white"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
